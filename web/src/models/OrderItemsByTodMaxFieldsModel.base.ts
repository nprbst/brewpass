...
/**
 * OrderItemsByTodMaxFieldsBase
 * auto generated base class for the model OrderItemsByTodMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const OrderItemsByTodMaxFieldsModelBase = ModelBase
  .named('OrderItemsByTodMaxFields')
  .props({
    __typename: types.optional(types.literal("order_items_by_tod_max_fields"), "order_items_by_tod_max_fields"),
...
export class OrderItemsByTodMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromOrderItemsByTodMaxFields() {
  return new OrderItemsByTodMaxFieldsModelSelector()
}

export const orderItemsByTodMaxFieldsModelPrimitives = selectFromOrderItemsByTodMaxFields().count.hour_of_day.last_order.menu_item.menu_item_id.venue.venue_id
