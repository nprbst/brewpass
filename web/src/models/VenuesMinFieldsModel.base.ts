...
/**
 * VenuesMinFieldsBase
 * auto generated base class for the model VenuesMinFieldsModel.
 *
 * aggregate min on columns
 */
export const VenuesMinFieldsModelBase = ModelBase
  .named('VenuesMinFields')
  .props({
    __typename: types.optional(types.literal("venues_min_fields"), "venues_min_fields"),
...
export class VenuesMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromVenuesMinFields() {
  return new VenuesMinFieldsModelSelector()
}

export const venuesMinFieldsModelPrimitives = selectFromVenuesMinFields().created_at.deleted_at.lat.long.name.osm_id.updated_at
